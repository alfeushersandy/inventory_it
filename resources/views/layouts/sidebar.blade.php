<aside class="sidebar">
    ...
    <a href="{{ route('dashboard.index') }}"
        class="{{ Request::is('dashboard') ? 'sidebar-item active' : 'sidebar-item' }}">
    ...
    <a href="{{ route('kategori.index') }}"
        class="{{ Request::is('kategori*') ? 'sidebar-item active' : 'sidebar-item' }}">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    <a href="{{ route('kembali.index') }}"
        class="{{ Request::is('kembali*') ? 'sidebar-item active' : 'sidebar-item' }}">
    ...
    <a href="{{ route('maintenance.index') }}"
        class="{{ Request::is('maintenance*') ? 'sidebar-item active' : 'sidebar-item' }}">
        <!-- <img src="./assets/img/global/home.svg" alt=""> -->
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z"
    ...
    <a href="{{ route('report.index') }}" class="sidebar-item">
