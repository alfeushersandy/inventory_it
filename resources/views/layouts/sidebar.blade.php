<aside class="sidebar">
    ...
    <a href="{{route('kategori.index')}}" class="sidebar-item" onclick="toggleActive(this)">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="{{route('lokasi.index')}}" class="sidebar-item" onclick="toggleActive(this)">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="{{route('barang.index')}}" class="sidebar-item" onclick="toggleActive(this)">
